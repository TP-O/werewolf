...
// Source: storage/postgres/store.go
...
import (
	context "context"
	reflect "reflect"
	postgres "uwwolf/storage/postgres"
...
func (m *MockStore) AssignGameRoles(ctx context.Context, arg postgres.AssignGameRolesParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateGameLogs(ctx context.Context, arg postgres.CreateGameLogsParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) FinishGame(ctx context.Context, arg postgres.FinishGameParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) StoreGame(ctx context.Context, params *postgres.StoreGameParams) error {
	m.ctrl.T.Helper()
