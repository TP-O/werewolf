...
func (m *MockManager) Moderator(gameID types.GameID) game.Moderator {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Moderator", gameID)
	ret0, _ := ret[0].(game.Moderator)
	return ret0
}
...
func (m *MockManager) ModeratorOfPlayer(playerID types.PlayerID) game.Moderator {
	m.ctrl.T.Helper()
...
func (m *MockManager) RegisterGame(registration *types.GameRegistration) (game.Moderator, error) {
	m.ctrl.T.Helper()
