...
// Source: game/mechanism/contract/player.go
...
func (m *MockPlayer) Move(x, y float64) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Move", x, y)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPlayerMockRecorder) Move(x, y interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Move", reflect.TypeOf((*MockPlayer)(nil).Move), x, y)
}
